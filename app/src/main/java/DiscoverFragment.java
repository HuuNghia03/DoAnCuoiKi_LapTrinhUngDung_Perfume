...
public class DiscoverFragment extends Fragment {
    ...
    private com.example.perfume.NewsAdapter newsAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        // Nếu là lần đầu chạy, thêm dữ liệu mẫu vào DB
        ...
        // Lấy danh sách từ DB và gán vào Adapter
        List<com.example.perfume.NewsItem> newsList = dbHelper.getAllNews();
        newsAdapter = new com.example.perfume.NewsAdapter(newsList);

...
import com.example.perfume.BrandSeeMore;
import com.example.perfume.NoteSeeMore;
import com.example.perfume.PerfumeSeeMore;
...
public class SearchFragment extends Fragment {
    ...
    private void openPerfumeSeeMore() {
        openSeeMoreFragment(new PerfumeSeeMore(), "PerfumeSeeMore");
    }

    private void openBrandSeeMore() {
        openSeeMoreFragment(new BrandSeeMore(), "BrandSeeMore");
    }

    private void openNoteSeeMore() {
        openSeeMoreFragment(new NoteSeeMore(), "NoteSeeMore");
    }

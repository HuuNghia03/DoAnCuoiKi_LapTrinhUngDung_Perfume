...
public class SplashActivity extends AppCompatActivity {
    ...
    private void loadPerfumeFromFirestore() {
        FirebaseFirestore.getInstance().collection("perfumes_list_25_2")
                .get()
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    ...
                    for (QueryDocumentSnapshot doc : queryDocumentSnapshots) {
                        ...
                        int topNoteId = doc.getLong("TopNoteId") != null ? doc.getLong("TopNoteId").intValue() : 0;
                        perfume.setTopNoteId(topNoteId);
                        int hearNoteId = doc.getLong("HeartNoteId") != null ? doc.getLong("HeartNoteId").intValue() : 0;
                        perfume.setHeartNoteId(hearNoteId);
                        int baseNoteId = doc.getLong("BaseNoteId") != null ? doc.getLong("BaseNoteId").intValue() : 0;
                        perfume.setBaseNoteId(baseNoteId);
    ...
    private void loadNotesFromFirestore() {
        FirebaseFirestore.getInstance().collection("Group_Note1")
                .get()
                .addOnSuccessListener(queryDocumentSnapshots -> {

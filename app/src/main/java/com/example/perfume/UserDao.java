...
public interface UserDao {
    ...
    @Query("UPDATE users SET isFirstTime= :isFirstTime, gender = :gender, age = :age, categoryList = :categoryList, favoriteSeason = :favoriteSeason, " +
    ...
    void updateUserPreferences(int id, boolean isFirstTime, String gender, Integer age, String categoryList, String favoriteSeason,
